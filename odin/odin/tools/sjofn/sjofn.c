//---------------------------------------------------------------------------------------
//
// Sjofn: ELF object files linker for Odin ($Revision: 1.1 $)
//
...
opt_option options[] =
{
   ...
   {  0,  "abort-on-warning",   0, opt_linker_options,     OPT_ABORT_ON_WARN, "error exit even on warnings"                         },
