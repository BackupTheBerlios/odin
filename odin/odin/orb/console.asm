...
console_mt_sect:
   ...
   dd    0                                                 ;pad to align
   mt_method method_ctor
   mt_method method_dtor
   mt_method method_gotoxy
   mt_method method_scroll_up
   mt_method method_newline
   mt_method method_print_int
   mt_method method_print_char
   mt_method method_print_dword
   mt_method method_print_word
   mt_method method_print_byte
   mt_method method_print
   mt_method method_debug_showregs
   mt_method method_debug_showstack
   mt_method method_debug_showmem
   mt_method method_wait_ack
console_mt_sect_end:
...
create_console_component:
   ...
   add     eax, [ orb_linear ]                             ;linear address of our img in EAX
   ...
   METHOD_CREATE ; ** FAILS SOMEWHERE HERE **
   add   esp, 12
