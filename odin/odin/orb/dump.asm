...
cdt.ds_sel:      db EOL,"ds_sel                      : ",0
cdt.cs_sel:      db EOL,"cs_sel                      : ",0
cdt.type_ptr:    db EOL,"type_ptr (init_ref)         : ",0
cdt.mtbl:        db EOL,"mtbl (next)                 : ",0
cdt.mcount:      db EOL,"mcount                      : ",0
cdt.stack:       db EOL,"call_count (bss_sz) (stack) : ",0
cdt.descr:       db EOL,"descr                       : ",0
cdt.lock_count:  db EOL,"gdt_lock                    : ",0
